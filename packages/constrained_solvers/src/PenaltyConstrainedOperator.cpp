...
struct PenaltyConstrainedOperator<T,I>::Impl {
    using Interface = PenaltyConstrainedOperator<T,I>;
    ...
    Verbosity verbosity;
}; // struct PenaltyConstrainedOperator::Impl


template <NumericLike T, IntegerLike I>
PenaltyConstrainedOperator<T,I>& PenaltyConstrainedOperator<T,I>::operator=(PenaltyConstrainedOperator&&) noexcept = default;


template <NumericLike T, IntegerLike I>
PenaltyConstrainedOperator<T,I>::~PenaltyConstrainedOperator() = default;


template <NumericLike T, IntegerLike I>
PenaltyConstrainedOperator<T,I>::PenaltyConstrainedOperator(
        ...
        :   Base(
            ...
            _pImpl(new Impl) {
                ...
                CIE_BEGIN_EXCEPTION_TRACING
                    ...
                    _pImpl->constrainedRowExtents.insert(
                        _pImpl->constrainedRowExtents.end(),
                        constraintGradients.rowExtents().begin(),
                        constraintGradients.rowExtents().end());
                    _pImpl->constrainedColumnIndices.insert(
                        _pImpl->constrainedColumnIndices.end(),
                        constraintGradients.columnIndices().begin(),
                        constraintGradients.columnIndices().end());
                    _pImpl->constrainedEntries.insert(
                        _pImpl->constrainedEntries.end(),
                        constraintGradients.entries().begin(),
                        constraintGradients.entries().end());
...
template <NumericLike T, IntegerLike I>
void PenaltyConstrainedOperator<T,I>::product(
...
#define CIE_INSTANTIATE_PENALTY_OPERATOR(T, I)  \
    template class PenaltyConstrainedOperator<T,I>;
